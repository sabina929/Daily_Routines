        ...
        return (
            <StyledRoutine>
               ...
               <div style={{
                    ...
                    <RoutineInput handleChange={handleChange} handleSubmit={handleSubmit} item={item} unCheckAll={unCheckAll}/>
                    <RoutineList items={items} checkToggle={checkToggle} removeItem={removeItem} editItem={editItem}/>
               </div>
